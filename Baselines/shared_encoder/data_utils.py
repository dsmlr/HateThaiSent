...
class Multitask_Dataset(Dataset):
    def __init__(self, input_ids, attention_masks, labels_task1, labels_task2):
    ...
    def __getitem__(self, idx):
        ...
        return input_ids.squeeze(dim=0), attention_masks.squeeze(dim=0), label_task1.to(dtype = torch.float64), label_task2.to(dtype = torch.float64)